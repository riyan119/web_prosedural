...
<div class="row">
        ...
        <div class="row">
        	<div class="col-lg-12">
        		<div class="table-responsive">
                    ...
                    <thead>
        				<tr>
        					...
        					<th>Gambar Barang</th>
                            <th>Tgl Publish</th>
                            <!-- <input type="text" x-webkit-speech name=""> -->
        					<th>Opsi</th>
        				</tr>
                    </thead>
                    <tbody>
        				...
        				<tr>
        					...
        					<td align="center"><img src="assets/img/barang/<?php echo $data->gbr_brg; ?>"  class="gambar-barang"> </td>
        					...
        					<td align="center">
                                ...
                                <a href="?page=barang&act=del&id=<?php echo $data->id_brg; ?>" onclick="return confirm('Yakin akang menghapus data ini?')">
        						<button class="btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i> Hapus</button></a>

                                <a  target="_blank" href="./report/cetak_barang.php?id=<?=$data->id_brg ?>" class="btn btn-default btn-xs"><i class="fa fa-print"></i> Cetak</a>
        					</td>
        				</tr>
                        <?php 
                ...
                <a class="btn btn-success" data-toggle="modal" data-target="#tambah"><i class="fa fa-plus"></i> Tambah Data</a>
                <a class="btn btn-default" href="./report/export_excel_barang.php" target="_blank"> 
                    <i class="fa fa-print"></i> Report Excel
                </a>                   
