<fieldset>
	...
	<table>
		...
		<tr>
			...
			<td></td>
			<td>
				<input type="submit" name="masuk" value="Masukkin" />
	...
	if ($edit_mobil) {
		if ($merk == "" || $type== "" || $warna== "" || $harga == ""  ) {
			...
			if ($nama_gambar=="") {
				mysql_query("update tb_mobil set merk='$merk', type='$type', warna='$warna', harga='$harga' where kode_mobil='$kd_mobil' ") or die(mysql_error());
			?>
			<script type="text/javascript">
			...
			<?php
				...
				if ($pindah) {
					mysql_query("update tb_mobil set merk='$merk', type= '$type' , warna='$warna', harga='$harga', gambar='$nama_gambar' where kode_mobil='$kd_mobil' ") or die(mysql_error());
				?> 
				<script type="text/javascript">
